                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="product p-4">
                            ...
                            <div class="mt-4 mb-3"> <span class="text-uppercase text-muted brand">Plans</span>
                                <h5 class="text-uppercase">{{$plan->plan_name}}</h5>
                                <div class="price d-flex flex-row align-items-center"> 
                                </div>
                            </div>
                            <p class="about"> plan_duration:  {{$plan->plan_duration}}</p>
                            <div class="sizes mt-3">
                                <p>{{$plan->price}}</p>
                            </div>
                            <div class="cart mt-6 align-items-center"><a href=""> <button class="btn btn-danger text-uppercase mr-2 px-4">rent now</button></a></div>
                        </div>
                    </div>
                </div>
            </div>
